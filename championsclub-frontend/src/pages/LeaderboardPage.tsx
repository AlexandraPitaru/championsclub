...
//     medal: "gold",
//     name: "Mara Ionescu",
//     email: "mara.ionescu@championsclub.com",
//     avatar: "MI",
//     tier: "Gold",
//     points: 1240,
//     performance: 100,
...
//     medal: "silver",
//     name: "Andrei Pop",
//     email: "andrei.pop@championsclub.com",
//     avatar: "AP",
//     tier: "Silver",
//     points: 1130,
//     performance: 91,
...
//     medal: "bronze",
//     name: "Ioana Matei",
//     email: "ioana.matei@championsclub.com",
//     avatar: "IM",
//     tier: "Silver",
//     points: 1045,
//     performance: 84,
...
//     rank: 4,
//     name: "Radu Georgescu",
//     email: "radu.georgescu@championsclub.com",
//     avatar: "RG",
//     tier: "Bronze",
//     points: 830,
//     performance: 67,
...
//     email: "elena.dumitrescu@championsclub.com",
//     avatar: "ED",
//     tier: "Bronze",
//     points: 765,
//     performance: 62,
...
//     rank: 6,
//     name: "Vlad Stan",
//     email: "vlad.stan@championsclub.com",
//     avatar: "VS",
//     tier: "Bronze",
//     points: 610,
//     performance: 49,
...
// export default function LeaderboardPage() {
//   const topAdvisor = leaderboardRows[0];
//   const totalAdvisors = leaderboardRows.length;
//   const averagePoints = Math.round(
//     leaderboardRows.reduce((acc, row) => acc + row.points, 0) / totalAdvisors
//   );
//   const totalPoints = leaderboardRows.reduce((acc, row) => acc + row.points, 0);
...
//               <p className="font-semibold text-slate-900">{topAdvisor.name}</p>
//               <p className="text-sm font-semibold text-slate-700">
//                 {topAdvisor.points} pts
//               </p>
//             </div>
//           </Card>
...
//               <p className="text-3xl font-bold text-slate-900">{totalAdvisors}</p>
...
//               <p className="text-sm font-medium text-emerald-600">+8.2% vs last week</p>
//             </div>
//           </Card>
...
//               </p>
//               <p className="text-sm font-medium text-emerald-600">+12.4% vs last week</p>
//             </div>
//           </Card>
//         </section>
...
//             <button className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700">
...
//                   <tr
//                     key={row.id}
//                     className={row.rank === 1 ? "bg-amber-50/70" : "bg-white"}
//                   >
...
//                           <div
//                             className={"h-2 rounded-full " + progressColor(row.rank)}
...
//             <button className="rounded-md border border-slate-300 p-2 text-slate-500 hover:bg-slate-50">
//               <ChevronLeft className="h-4 w-4" />
//             </button>
//             <button className="rounded-md bg-slate-900 px-3 py-1.5 text-sm font-semibold text-white">
//               1
//             </button>
//             <button className="rounded-md border border-slate-300 px-3 py-1.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">
//               2
//             </button>
//             <button className="rounded-md border border-slate-300 p-2 text-slate-500 hover:bg-slate-50">
